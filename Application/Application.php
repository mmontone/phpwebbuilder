...
require_once 'SpanishTranslator.class.php';
...
require_once 'components/Widgets/NavigationLink.class.php';
require_once 'components/Widgets/GoBackLink.class.php';
...
require_once 'components/ErrorDialog.class.php';
?>
