...
require_once 'JSComponent.class.php';
...
require_once 'components/Widgets/JSCommandLink.class.php';
...
require_once 'components/JSNotificationDialog.class.php';
require_once 'components/QuestionDialog.class.php';
require_once 'components/JSQuestionDialog.class.php';
require_once 'components/PermissionsChecker.class.php';
require_once 'components/PromptDialog.class.php';
require_once 'components/JSPromptDialog.class.php';
require_once 'components/ErrorDialog.class.php';
require_once 'components/JSErrorDialog.class.php';
?>
