...
Los datos del modelo en general, necesitan ser persistidos, es decir, guardados para que en otra ejecución de la aplicación, simultánea o posterior, por este u otro usuario, puedan ser accedidos.
