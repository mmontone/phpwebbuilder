...
\PWB es un Framework Open Source Orientado a Objetos escrito en PHP para el desarrollo de aplicaciones Web, tanto de Internet como de una Intranet. Incluye varias características interesantes como templates declarativos, desarrollo por componentes, OORM bajo persistencia por alcance, distintos engines de rendereo, compilación, macros y mixins, entre otras cosas}
