...
\PWB \ es un Framework Open Source Orientado a Objetos escrito en PHP para el desarrollo de aplicaciones Web, tanto de Internet como de una Intranet. Incluye muchas características producto de la experiencia en el desarrollo de este tipo de aplicaciones. Algunas características interesantes son templates declarativos, desarrollo por componentes, OORM bajo persistencia por alcance, distintos engines de rendereo, compilación, macros y mixins.}
