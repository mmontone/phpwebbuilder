...
El diseño y desarrollo de aplicaciones (tanto de escritorio como web) plantea muchos problemas reiterativos. Existen múltiples soluciones para cada una de ellas, cargando sobre el programador la responsabilidad de seleccionarlas e integrarlas. \PWB\ es un Framework Open Source Orientado a Objetos escrito en PHP para el desarrollo de aplicaciones Web, tanto de Internet como de una Intranet, que integra soluciones a cada uno de estos problemas, producto de la experiencia en el desarrollo de este tipo de aplicaciones.
