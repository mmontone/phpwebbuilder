...
class Counter extends Component
{
	...
	function question_incrementation() {
          $this->call (new QuestionDialog("Do you really want to increment?", array('on_yes' => callback($this, 'notify_incrementation'),
                                                                                  'on_no' => callback($this, 'user_cancelled'))));
	}
	function question_decrementation() {
          $this->call (new QuestionDialog("Do you really want to decrement?", array('on_yes' => callback($this, 'notify_decrementation'),
                                                                                  'on_no' => callback($this, 'user_cancelled'))));
	}
	function notify_incrementation() {
          $this->call (new NotificationDialog('Going to increment', array('on_accept' => callback($this, 'increment'))));
	}
	function notify_decrementation() {
          $this->call (new NotificationDialog('Going to decrement', array('on_accept' => callback($this, 'decrement'))));
	}
