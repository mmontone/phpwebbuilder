...
var pathToImages = 'lib/calendar/images/';	// Relative to your HTML file

Event.observe(window, 'load', function (){pathToImages = $F('pwb_url')+'lib/calendar/images/';});
...
try{
	...
	if(returnFormat){
		...
		returnDateTo.dispatchEvent(event);
		enqueueChange(returnDateTo,inputGetValue);
        // End PWB Code
	}else{
