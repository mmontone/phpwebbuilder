...
function openWindow(pos, params){
	...
	rw.open(document.getElementById("app").getAttribute("action")+'&app='+document.getElementById("app_class").getAttribute("value")+'&date='+new Date().getTime()+'&window='+pos,pos, params);
}
