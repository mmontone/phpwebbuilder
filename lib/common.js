...
function autocomplete(elemid){
    ...
    new Ajax.Autocompleter(elemid+'-displayText', elemid+'-listDisplay', $F('pwb_url')+"lib/autocomplete.php",
        {paramName:'value',afterUpdateElement: function(input, selected){$(elemid+'-elementId').value=selected.value;},parameters: 'basedir='+$F('basedir')+'&app='+$F('app_class')+'&component='+elemid});
        }catch(e){}
}
