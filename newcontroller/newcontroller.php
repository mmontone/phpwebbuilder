...
require_once 'HistoryListener.class.php';
...
require_once 'components/Widgets/XML/XMLTextNode.class.php';
require_once 'components/Widgets/XML/XMLNode.class.php';
require_once 'components/Widgets/XML/NullView.class.php';
require_once 'components/Widgets/XML/DOMXMLNode.class.php';
require_once 'components/Widgets/XML/XMLModification.class.php';
require_once 'components/Widgets/XML/PageRenderer.class.php';
require_once 'components/Widgets/XML/XMLNodeModificationsTracker.class.php';
require_once 'components/Widgets/Text.class.php';
...
require_once 'components/Widgets/Link.class.php';
require_once 'components/Widgets/PermissionChecker.class.php';
require_once 'components/Widgets/Password.class.php';
require_once 'components/Widgets/Filename.class.php';
require_once 'components/Widgets/Label.class.php';
